...
namespace Airtime.Http
{
    class Request
    {
       
        public static Response checkOperator(Models.Transaction transaction)
        {
            ...
            try
            {
                ...
                {
                    HttpResponseMessage response = client.PostAsync(Global.Global.URL_CHECK_OP, q).Result;
        ...
        public static Response validInsert(Models.Transaction transaction)
        {
            ...
            try
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    HttpResponseMessage response = client.PostAsync(Global.Global.URL_VALID_AMOUNT, q).Result;
                    HttpContent content = response.Content;
                    string reponse = content.ReadAsStringAsync().Result;
                    resultat = JsonConvert.DeserializeObject<Response>(reponse);
                }
