...
namespace Airtime.Global
{
    class Global
    {
        public static string ID = "6";
        public static string SERVICE = "10";
        ...
        private static string BASE_URL = URL + "airtime/";
        public static string URL_CHECK_OP = BASE_URL + "check_op";

        public static string URL_ENTER_INFO = BASE_URL + "enter_info";

        public static string URL_VALID_AMOUNT = BASE_URL + "valid_amount";
