...
namespace EUM.Http
{
    class Request
    {
        public static Response checkAccount(Models.Transaction transaction)
        {
        ...
        public static Response enterInformation(Models.Transaction transaction)
        {
            Response resultat = null;
            IEnumerable<KeyValuePair<string, string>> queries = new List<KeyValuePair<string, string>>()
            {
                ...
                new KeyValuePair<string,string>("transaction_id",transaction.transactionId.ToString()),
                new KeyValuePair<string,string>("phone","237"+transaction.phone),
                new KeyValuePair<string,string>("sender",transaction.sender),
                new KeyValuePair<string,string>("receiver",transaction.receiver),
        ...
        public static Response validateInsert(Models.Transaction transaction)
        {
            Response resultat = null;
            IEnumerable<KeyValuePair<string, string>> queries = new List<KeyValuePair<string, string>>()
            {
