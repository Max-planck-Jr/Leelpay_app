...
namespace MoMo.Global
{
    class Global
    {
        public static string ID = "6";
        public static string SERVICE = "25";
        ...
        private static string BASE_URL = URL + "momo/";
        public static string URL_CHECK_ACCOUNT = BASE_URL + "check_op";

        public static string URL_ENTER_INFO = BASE_URL + "enter_info";

        public static string URL_AMOUNT_INSERT = BASE_URL + "valid_insert";
